...
import FillterModel from '../../components/fillterModel'
  ...
  return (
    <View style={[styles.container,{paddingTop}]}>
      ...
      <ScrollView
        ...
        scrollEventThrottle={5}//how often scroll event wil fire while scrolling
        ref={scrollRef}
                  ...
                  Object.keys(filters).map((key,index)=>{
                    return (
                      <View key={key} style={styles.filterItem}> 
                      {
                        ...
                        </View>):(  <Text style={styles.filterItemText}>{filters[key]}</Text>)
                      }
